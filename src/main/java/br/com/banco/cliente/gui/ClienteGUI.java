...
public class ClienteGUI extends JFrame {
    ...
    public ClienteGUI() {
        ...
        // --- MUDANÇA NA ORDEM ---
        // 1. Define o botão padrão ANTES de qualquer outra coisa.
        getRootPane().setDefaultButton(conectarButton);

        // 2. Configura o fechamento e empacota a janela.
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        pack();

        // 3. Centraliza e torna visível.
    ...
    public static void main(String[] args) {
        try {
            ...
            UIManager.put("ProgressBar.foreground", azulPrincipal);
